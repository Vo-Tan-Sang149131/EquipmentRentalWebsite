package com.luxrental.controller.order;
...
public class OrderController extends BaseController {
    ...
    @GetMapping("/owner")
    public ResponseEntity<MyApiResponse<Page<OrderSummaryResponse>>> getOrdersForOwner(
    ...
    public ResponseEntity<MyApiResponse<OrderSummaryResponse>> confirmOrder(
    ...
    public ResponseEntity<MyApiResponse<OrderSummaryResponse>> rejectOrder(
        @PathVariable Long orderId,
        @AuthenticationPrincipal CustomUserDetails userDetails
    ) {
        Long ownerId = userDetails.getId();
    ...
    public ResponseEntity<MyApiResponse<java.util.List<OrderSummaryResponse>>> getMyOrders(
        @AuthenticationPrincipal CustomUserDetails userDetails
    ) {
