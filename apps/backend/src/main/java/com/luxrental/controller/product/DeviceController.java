...
import com.luxrental.controller.product.dto.device.request.DeviceRequest;
import com.luxrental.controller.product.dto.device.request.DeviceUpdateRequest;
import com.luxrental.controller.product.dto.device.response.DeviceEditResponse;
import com.luxrental.controller.product.dto.device.response.DeviceDetailResponse;
import com.luxrental.controller.product.dto.device.response.DeviceManageResponse;
import com.luxrental.enums.DeviceStatus;
import com.luxrental.security.normal.CustomUserDetails;
import com.luxrental.service.product.DeviceService;
...
public class DeviceController extends BaseController {
    ...
    public ResponseEntity<MyApiResponse<List<DeviceManageResponse>>> getPendingDevices() {
        List<DeviceManageResponse> list = deviceService.getDevicesByStatus(DeviceStatus.PENDING_APPROVAL);
