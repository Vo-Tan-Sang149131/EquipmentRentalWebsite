package com.luxrental.service.order;

import com.luxrental.controller.order.dto.request.CheckoutRequest;
import com.luxrental.controller.order.dto.response.CheckoutResponse;
...
import com.luxrental.repository.order.OrderDetailRepository;
...
public class OrderService {
    ...
    public java.util.List<OrderSummaryResponse> getOrdersForOwner(Long ownerId) {
    ...
    @Transactional(readOnly = true)
    public Page<OrderSummaryResponse> getOrdersForOwnerPaged(Long ownerId, Pageable pageable) {
    ...
    @Transactional
    public OrderSummaryResponse confirmOrder(Long orderId, Long ownerId) {
    ...
    @Transactional
    public OrderSummaryResponse rejectOrder(Long orderId, Long ownerId) {
        Order order = orderRepository.findById(orderId)
            .orElseThrow(() -> new EntityNotFoundException("Order not found with ID: " + orderId));
    ...
    private OrderSummaryResponse buildOrderSummaryResponse(Order o, Long ownerId) {
