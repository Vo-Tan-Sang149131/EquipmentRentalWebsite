...
import com.luxrental.controller.product.dto.device.response.*;
...
import com.luxrental.controller.product.dto.core.response.SpecificationDTO;
...
public class DeviceService {
    ...
    @Transactional
    public void updateDeviceByOwner(Long deviceId, Long ownerId, DeviceUpdateRequest request) {
        Device device = deviceRepository.findById(deviceId)
            .orElseThrow(() -> new EntityNotFoundException("Device not found"));
    ...
    @Transactional(readOnly = true)
    public List<DeviceManageResponse> getDevicesByStatus(DeviceStatus status) {
